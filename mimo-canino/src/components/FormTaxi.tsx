  ...
  return (
    <>
      <Form action='/' method="get">
        ...
        <Row className="g-2">
          <Col md>
            <Form.Label htmlFor="endereço">Endereço</Form.Label>
            <Form.Control
              type="text"
              id="inputTextEndereço"
              aria-describedby="textNameEndereço"
            />
          </Col>
          <Col md>
        ...
        <FloatingLabel controlId="observacoes" label="Observações (caso tenha)">
          <Form.Control
            as="textarea"
        ...
        <Button id='botao-banho' type="submit" variant='dark'>Pedir seu Taxi</Button>
      </Form>
    </>
  );
}
